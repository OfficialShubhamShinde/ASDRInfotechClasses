...
<head>
    <meta charset="utf-8">
    <title>Sales & Marketing - ASDR Infotech</title>
...
<body>
                                ...
                                <div class="dropdown-menu" aria-labelledby="coursesDropdown">
                                    ...
                                    <div class="dropdown-submenu dropright">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item active" href="salesandmarketing">Sales and
                                                Marketing</a>
                                        </div>
                                    </div>
    ...
    <div class="container-fluid page-header" style="margin-bottom: 10px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">Sales and Marketing</h3>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 0rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
            ...
            <h1 class="course-title" style="color: #FF6600;">Sales and Marketing</h1>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>Sales and Marketing course is designed to provide participants with a comprehensive
                        understanding of key concepts and strategies in sales and marketing. Through practical examples
                        and case studies, participants will learn effective sales techniques, marketing principles,
                        customer relationship management, market research, digital marketing, and branding strategies to
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>The course is open to individuals from various backgrounds, including students, professionals,
                        entrepreneurs, and anyone interested in sales and marketing. No specific prerequisites are
                        required, making it accessible to beginners in the field</ul>
                    </p>
                </div>
                <!-- <div class="col-lg-3">
            <center>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>
                        <li>Gain a strong foundation in sales and marketing principles. </li>

                        <li>Course completion certificate</li>

                        <li>Internship Certificate</li>

                        <li>Learn effective sales techniques and customer relationship management strategies.</li>

                        <li>Understand market research and analysis to make informed business decisions. </li>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 1rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
                    ...
                    <div class="accordion">
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(1)">
                                <h5>1: Introduction to Sales and Marketing</h5>
                            </div>
                            <div class="accordion-content" id="accordion-1">
                                <ul>
                                    <li>Overview of sales and marketing</li>
                                    <li>Importance of sales and marketing in business</li>
                                    <li>Key roles and responsibilities in sales and marketing</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(2)">
                                <h5>2: Understanding the Market</h5>
                            </div>
                            <div class="accordion-content" id="accordion-2">
                                <ul>
                                    <li>Market research and analysis</li>
                                    <li>Identifying target markets and customer segments</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(3)">
                                <h5>3: Consumer Behaviour</h5>
                            </div>
                            <div class="accordion-content" id="accordion-3">
                                <ul>
                                    <li>Understanding consumer needs and wants</li>
                                    <li>Factors influencing consumer decision-making</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(5)">
                                <h5>5: Marketing Mix - Promotion and Distribution Strategies</h5>
                            </div>
                            <div class="accordion-content" id="accordion-5">
                                <ul>
                                    ...
                                    <li>Distribution channels and logistics</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(7)">
                                <h5>7: Sales Techniques and Strategies</h5>
                            </div>
                            <div class="accordion-content" id="accordion-7">
                                <ul>
                                    <li>Sales process and sales funnel</li>
                                    <li>Sales prospecting and lead generation</li>
                                    <li>Sales presentations and pitching</li>
                                    <li>Handling objections and closing sales</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(8)">
                                <h5>8: Customer Relationship Management (CRM)</h5>
                            </div>
                            <div class="accordion-content" id="accordion-8">
                                <ul>
                                    <li>Importance of CRM in sales and marketing</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(9)">
                                <h5>9: Sales and Marketing Metrics and Analytics</h5>
                            </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(10)">
                                <h5>10: Sales and Marketing Planning</h5>
                            </div>
                            <div class="accordion-content" id="accordion-10">
                                <ul>
                                    <li>Developing a marketing plan</li>
                                    <li>Creating sales strategies and action plans</li>
            ...
            <p style="font-size: 10px; margin-top: 1rem;"> This syllabus provides a general outline for a Sales and
                Marketing course. The instructor can further customise it based on the students' needs and the course
                objectives. Additional topics like sales negotiation, sales management, international marketing, or
                specific industry-focused marketing strategies can be included if desired.
            </p>
        </div>
    </div>
    </div>
