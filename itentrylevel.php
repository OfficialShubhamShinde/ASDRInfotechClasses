...
<head>
    <meta charset="utf-8">
    <title>IT Entry Level - ASDR Infotech</title>
...
<body>
                                ...
                                <div class="dropdown-menu" aria-labelledby="coursesDropdown">
                                    ...
                                    <div class="dropdown-submenu dropright">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item active" href="itentrylevel">IT Entry Level Program</a>
                                        </div>
                                    </div>
    ...
    <div class="container-fluid page-header" style="margin-bottom: 10px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">IT ENTRY LEVEL PROGRAM</h3>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 0rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
            ...
            <h1 class="course-title" style="color: #FF6600;">IT Entry Level Program</h1>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>This program is targeted at any graduate who aspires to be an Information technology
                        professional. We provide career guidance and define the career roadmap and internship program to
                        get real-world experience.
                    </ul>
                    <ul>
                        Our bridge the gap program offers training that will guide you on your career path.

                        It consists of 4 components</ul>
                    <ul>
                        <li>Assessment: we will give you a questionnaire to check your current level </li>
                        <li>The intensive 3-week workshop focuses on job search and workplace integration.</li>
                        <li>8-week Technical Training-Foundation and Advanced Courses (Duration may vary depending on
                            course selection and candidates technical background) </li>
                ...
                <div class="col-lg-3">
                    <center>
                        <img src="img/fasttrack1.jpg" alt="" style="width: 200px;">
                    </center>
                </div>
            </div>
