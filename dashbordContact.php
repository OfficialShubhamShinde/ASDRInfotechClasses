...
<body style="font-family: 'Poppins', sans-serif;">
    ...
    <div class="sidebarMenu">
        ...
        <div class="container">
            ...
            <center>
                <h2 class="text-primary text-uppercase mb-3" style="letter-spacing: 5px;">Contact Details</h2>
            </center>
            <br>
            <!-- Header End -->
            <?php
            $SelFetch = "select * from contact";
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>' . $formattedDate . '</td>
                                <td>' . $formattedTime . '</td>
                                <td><a href="mailto:' . $email . '"><button type="button" class="btn btn-primary btn-sm">Reply</button></a></td>
                            </tr>
                            ';
                            }
                            ?>
