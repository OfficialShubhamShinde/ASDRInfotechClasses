...
<head>
    <meta charset="utf-8">
    <title>ERP SAP - ASDR Infotech</title>
...
<body>
                        ...
                        <div class="navbar-nav py-0">
                            ...
                            if ($user_type !== 'student' && $user_type !== 'teacher') {
                                ...
                                <div class="dropdown-menu" aria-labelledby="coursesDropdown">
                                    ...
                                    <!-- ERP Trainings -->
                                    <div class="dropdown-submenu dropright">
                                        <a class="dropdown-item dropdown-toggle active" href="#" id="erpDropdown"
                                            data-toggle="dropdown">ERP Trainings</a>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="erp">ERP Foundation</a>
                                            <a class="dropdown-item active" href="erpsap">ERP(SAP) Advance</a>
                                        </div>
                                    </div>
    ...
    <div class="container-fluid page-header" style="margin-bottom: 10px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">ERP (SAP) Advance</h3>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 0rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
            ...
            <h1 class="course-title" style="color: #FF6600;">ERP (SAP) Advance</h1>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>The Advanced ERP (SAP) Implementation and Optimization course is designed to equip experienced
                        professionals with an in-depth understanding of SAP ERP systems and their advanced
                        implementation techniques. This course delves into the intricacies of SAP modules,
                        customization, integration, and performance optimization, enabling participants to harness the
                        full potential of SAP solutions to streamline business processes and drive efficiency.
                    </ul>
                    </p>
                ...
                <div class="col-lg-3">
                    <center>
                        <img src="img/erp2.jpg" alt="" style="width: 200px;">
                    </center>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>Experienced professionals with a strong foundation in SAP ERP systems or completion of a basic
                        SAP course. You should possess a deep interest in mastering advanced SAP customization,
                        integration, optimization, and troubleshooting techniques.</ul>
                    </p>
                </div>
                <!-- <div class="col-lg-3">
            <center>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>
                        <li>Acquire advanced skills in customizing SAP modules according to specific organizational
                            needs.</li>
                        ...
                        <li>Gain insights into best practices for change management during SAP upgrades and
                            enhancements.</li>

                        <li>Develop expertise in troubleshooting and resolving issues related to SAP implementation and
                            usage.</li>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 1rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
                    ...
                    <div class="accordion">
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(1)">
                                <h5>1: Advanced SAP Modules Configuration</h5>
                            </div>
                            <div class="accordion-content" id="accordion-1">
                                <ul>
                                    <li>In-depth customization of finance, supply chain, HR, and CRM modules.</li>
                                    <li>Advanced settings for compliance, reporting, and analytics.</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(2)">
                                <h5>2: Integration Strategies and Techniques</h5>
                            </div>
                            <div class="accordion-content" id="accordion-2">
                                <ul>
                                    <li>Advanced integration scenarios between SAP modules and third-party systems.</li>
                                    <li>Mastering SAP's integration tools and technologies.</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content" id="accordion-3">
                                <ul>
                                    <li>Analyzing performance bottlenecks in SAP processes.</li>
                                    <li>Advanced optimization techniques for database, memory, and code performance.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(4)">
                                <h5>4: SAP Security and Authorization</h5>
                            </div>
                            <div class="accordion-content" id="accordion-4">
                                <ul>
                                    <li>Advanced user authentication and authorization methods.</li>
                                    <li>Role-based access controls and advanced security configurations.</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(5)">
                                <h5>5: SAP Upgrade and Enhancement Best Practices</h5>
                            </div>
                            <div class="accordion-content" id="accordion-5">
                                <ul>
                                    <li>Planning and executing SAP system upgrades.</li>
                                    <li>Managing enhancements and add-ons for continuous improvement.</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(6)">
                                <h5>6: Advanced Troubleshooting and Issue Resolution</h5>
                            </div>
                            <div class="accordion-content" id="accordion-6">
                                <ul>
                                    <li>Debugging complex SAP issues and errors.</li>
                                    <li>Applying advanced problem-solving techniques.</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(7)">
                                <h5>7: Real-time Analytics with SAP HANA</h5>
                            </div>
                            <div class="accordion-content" id="accordion-7">
                                <ul>
                                    <li>Understanding SAP HANA's in-memory capabilities.</li>
                                    <li>Building real-time analytical solutions using SAP HANA.</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(8)">
                                <h5>8: Advanced SAP Project Management</h5>
                            </div>
                            <div class="accordion-content" id="accordion-8">
                                <ul>
                                    <li>Managing large-scale SAP implementations and projects.</li>
                                    <li>Risk management, stakeholder engagement, and change management.</li>
                                </ul>
                            </div>
                        </div>
            ...
            <p style="font-size: 10px; margin-top: 1rem;"> The course content and schedule are subject to change based
                on industry trends and advancements in the SAP ecosystem.
            </p>
        </div>
    </div>
    </div>
