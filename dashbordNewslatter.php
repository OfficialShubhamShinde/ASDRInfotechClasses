...
<head>
    <meta charset="utf-8">
    <title>Newsletter - ASDR Infotech</title>
...
<body style="font-family: 'Poppins', sans-serif;">
    ...
    <div class="sidebarMenu">
        ...
        <div class="container">
            <center>
                <h2 class="text-primary text-uppercase mb-3" style="letter-spacing: 5px;">Newsletter</h2>
            </center>
            <br>
            <?php 
             $SelFetch = "select * from newslatter";
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($querySelFetch)) {
                            ...
                            $formattedTime = date_format(date_create($datetime), 'h:i A');
                            // echo $formattedTime;
                        
                            $formattedDate = date_format(date_create($datetime), 'Y/m/d');
                            // echo $formattedDate;
                            ...
                            <tr>
                                ...
                                <td>' . $formattedDate . '</td>
                                <td>' . $formattedTime . '</td>
                                <td><a href="mailto:' . $email . '"><button type="button" class="btn btn-primary btn-sm">Message</button></a></td>
                            </tr>
            ...
            <?php 
                ...
                echo '
                <center><h3>Currently no any Newslatter available</h3></center>
                ';
             }
            ?>
