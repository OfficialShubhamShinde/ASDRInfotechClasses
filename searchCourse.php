...
<head>
    <meta charset="utf-8">
    <title>Search Courses | ASDR Infotech</title>
        ...
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                ...
                <div class="d-inline-flex text-white">
                    ...
                    <p class="m-0 text-uppercase"  id="searchResultTitile" >Courses</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mb-5">
                ...
                <h1 class="py-3" >Search results for <em>"<?php echo $SearchResult ?>"</em></h1>
            </div>
            ...
            <div class="row">
                ...
                $sql = "SELECT * FROM `courses` WHERE MATCH (course_name, course_description, syllabus_type) against ('$SearchResult')";
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        $cource_amount = $row["cource_amount"];
                        $img = $row["course_img"];
                        echo '
                                    <div class="col-lg-4 col-md-6 mb-4">
                                        <div class="rounded overflow-hidden mb-2">
                                        <img class="" height = "250" src="teacher/' . $row['course_img'] . '"alt="">
                                        <div class="bg-secondary p-4">
                                                <div class="d-flex justify-content-between mb-3">
                                                </div>
                                                <a class="h5" href="course_detail.php?course_id=' . $cid . '">
                                                    ' . $cname . '
                                                </a>
