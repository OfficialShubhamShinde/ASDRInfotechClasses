                                ...
                                <div class="dropdown-menu" aria-labelledby="coursesDropdown">
                                    ...
                                    <div class="dropdown-submenu dropright">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item active" href="cpp">c/c++</a>
...
<div class="container-fluid py-5" style="padding-bottom: 0rem !important;">
 ...
 <h1 class="course-title" style="color: #FF6600;">C/C++</h1>
        ...
        <div class="row align-items-center">
            ...
            <p><b class="text-primary text-uppercase mb-3">Description:</b><ul>The C/C++ Coding Language course provides a comprehensive introduction to programming using the C and C++ languages. Whether you're a beginner or seeking to enhance your programming skills, this course covers fundamental concepts, syntax, data structures, and practical applications of C and C++. 
            </ul> </p>
        ...
        <div class="col-lg-3">
            <center>
            <img src="img/c.jpg" alt="" style="width: 200px;">
            </center>
        </div>
    </div>
...
<div class="row align-items-center">
    <div class="col-lg-9">
       ...
       <p><b class="text-primary text-uppercase mb-3">Eligibility:</b><ul>
...
<ul>
<li>Master foundational concepts of C and C++ programming languages.</li>

<li>Course completion certificate</li>

<li>Internship Certificate</li>

<li>Gain practical coding experience through hands-on exercises.</li>

<li>Explore real-world applications and programming best practices.</li>
...
<div class="accordion-item">
        <div class="accordion-header" onclick="toggleAccordion(1)">
            <h5>1: Introduction to Programming and C/C++</h5>
        </div>
        <div class="accordion-content" id="accordion-1">
            <ul>
                <li>Basics of programming concepts</li>
                <li>Understanding the role of C/C++ in programming</li>
    ...
    <div class="accordion-item">
        <div class="accordion-header" onclick="toggleAccordion(2)">
            <h5>2: Variables, Data Types, and Operators</h5>
        </div>
        <div class="accordion-content" id="accordion-2">
            <ul>
                <li>Variables and their types</li>
                <li>Data types and their usage</li>
    ...
    <div class="accordion-item">
        <div class="accordion-header" onclick="toggleAccordion(3)">
            <h5>3: Control Flow Statements (if, else, switch, loops)</h5>
        </div>
        <div class="accordion-content" id="accordion-3">
            <ul>
                ...
                <li>Using loops for iterative tasks</li>
            </ul>
        </div>
    </div>
    ...
    <div class="accordion-item">
        <div class="accordion-header" onclick="toggleAccordion(4)">
            <h5>4: Functions and Modular Programming</h5>
        </div>
    ...
    <div class="accordion-item">
        <div class="accordion-header" onclick="toggleAccordion(5)">
            <h5>5: Arrays and Strings</h5>
        </div>
        <div class="accordion-content" id="accordion-5">
            <ul>
                <li>Arrays and their declaration</li>
                <li>Multi-dimensional arrays</li>
                <li>Manipulating strings</li>
                <li>String functions and operations</li>
            </ul>
        </div>
    </div>
    ...
    <div class="accordion-item">
        <div class="accordion-header" onclick="toggleAccordion(6)">
            <h5>6: Pointers and Memory Management</h5>
        </div>
        <div class="accordion-content" id="accordion-6">
            <ul>
                ...
                <li>Memory management practices</li>
            </ul>
        </div>
    </div>
    ...
    <div class="accordion-item">
        <div class="accordion-header" onclick="toggleAccordion(7)">
            <h5>7: Structures and Unions</h5>
        </div>
        <div class="accordion-content" id="accordion-7">
            <ul>
                <li>Defining and using structures</li>
                <li>Nested structures and arrays of structures</li>
                <li>Unions and their applications</li>
            </ul>
        </div>
    </div>
    ...
    <div class="accordion-item">
        <div class="accordion-header" onclick="toggleAccordion(8)">
            <h5>8: File Handling and Input/Output</h5>
        </div>
        <div class="accordion-content" id="accordion-8">
            <ul>
                <li>Working with files and streams</li>
                <li>Reading and writing data from/to files</li>
                <li>File manipulation and error handling</li>
            </ul>
        </div>
    </div>
    ...
    <div class="accordion-item">
        <div class="accordion-header" onclick="toggleAccordion(9)">
            <h5>9: Object-Oriented Programming (C++)</h5>
        </div>
        <div class="accordion-content" id="accordion-9">
            <ul>
                ...
                <li>Polymorphism and function overloading</li>
                <li>Encapsulation and data hiding</li>
                <li>Abstraction and access specifiers</li>
            </ul>
        </div>
    </div>
    ...
    <div class="accordion-item">
        <div class="accordion-header" onclick="toggleAccordion(10)">
            <h5>10: Templates and Standard Template Library (C++)</h5>
        </div>
        <div class="accordion-content" id="accordion-10">
            <ul>
                ...
                <li>Common STL containers (vector, list, map, etc.)</li>
                <li>Using STL algorithms and iterators</li>
            </ul>
        </div>
    </div>
    ...
    <div class="accordion-item">
        <div class="accordion-header" onclick="toggleAccordion(11)">
            <h5>11: Advanced Topics and Practical Projects</h5>
        </div>
        <div class="accordion-content" id="accordion-11">
            <ul>
                <li>Exception handling and error management</li>
                <li>Advanced data structures (linked lists, trees, graphs)</li>
                <li>Multi-file programming and modular design</li>
                <li>Practical coding projects integrating various concepts</li>
            </ul>
        </div>
    </div>
...
<p style="font-size: 10px; margin-top: 1rem;">Note: This syllabus provides a comprehensive outline for our C/C++ Course. The course content can be further customised to address specific industry standards, and advanced concepts as required by the students and the course objectives.</p>
    </div>
    </div>
</div>
