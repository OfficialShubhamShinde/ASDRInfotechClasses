...
<body>
    ...
    <div class="container-fluid page-header" style="margin-bottom: 0px;">
        <div class="container">
            <?php
            $selectName = "SELECT etitle FROM events WHERE event_id = '$e_id'";
            ...
            <form action="subscribe" method="POST">
                <div class="mb-3">
                    <div class="form-group d-flex justify-content-between">
                        <label for="exampleFormControlSelect1" class="form-label mb-0">First Name<span style="color:rgb(202, 0, 0)">*</span> </label>
                        <label for="exampleFormControlSelect2" class="form-label mb-0">Last Name<span style="color:rgb(202, 0, 0)">*</span></label>
                    </div>
                    <div class="form-group d-flex justify-content-between ">
                        <input type="text" class="form-control rounded  mr-3" id="email" name="email"
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <button class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">+91</button>
                        <div class="dropdown-menu">
                ...
                <label for="exampleFormControlTextarea1" class="form-label">Professional Experience</label>
                <div class="mb-3">
                    <input type="number" class="form-control rounded" id="exper" name="exper"
                        aria-describedby="emailHelp" placeholder="" required>
                </div>
                ...
                <center><button onclick="sendEmail()" value="Send an Email" id="btn"
                        class="btn btn-primary btn-lg px-4 me-md-2 mb-3 rounded">Register</button>
                </center>
            </form>
        </div>
    </div>
