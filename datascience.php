...
<head>
    <meta charset="utf-8">
    <title>Data Science - ASDR Infotech</title>
                            ...
                            if ($user_type !== 'student' && $user_type !== 'teacher') {
                                ...
                                <div class="dropdown-menu" aria-labelledby="coursesDropdown">
                                    ...
                                    <div class="dropdown-submenu dropright">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item active" href="datascience">Data Science</a>
                                        </div>
                                    </div>
    ...
    <div class="container-fluid page-header" style="margin-bottom: 10px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">Data Science</h3>
...
<div class="container-fluid py-5" style="padding-bottom: 0rem !important;">
 ...
 <h1 class="course-title" style="color: #FF6600;">Data Science</h1>
        ...
        <div class="col-lg-3">
            <center>
            <img src="img/ds1.jpg" alt="" style="width: 200px;">
            </center>
        </div>
    </div>
...
<ul>
<li>Develop a solid understanding of data science concepts and methodologies.</li>

<li>Course completion certificate</li>

<li>Internship Certificate</li>

<li>Gain proficiency in data manipulation, cleaning, and preprocessing.</li>

<li>Gain hands-on experience through real-world data projects and case studies.</li>
...
<div class="accordion-item">
    ...
    <div class="accordion-content" id="accordion-1">
        <ul>
            ...
            <li>Introduction to the data science workflow</li>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(2)">
        <h5>2: Data Acquisition and Data Wrangling</h5>
    </div>
    <div class="accordion-content" id="accordion-2">
        <ul>
            <li>Data sources and formats</li>
            <li>Collecting data from APIs and web scraping</li>
            <li>Data cleaning and preprocessing</li>
            <li>Dealing with missing values and outliers</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    ...
    <div class="accordion-content" id="accordion-3">
        <ul>
            <li>Descriptive statistics and data visualisation</li>
            <li>Summarising and visualising data distributions</li>
            <li>Detecting patterns and relationships in data</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(4)">
        <h5>4: Statistical Analysis and Hypothesis Testing</h5>
    </div>
    <div class="accordion-content" id="accordion-4">
        <ul>
            <li>Introduction to statistical concepts and methods</li>
            <li>Sampling and statistical inference</li>
            <li>Hypothesis testing and p-values</li>
            <li>Performing t-tests and chi-square tests</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(5)">
        <h5>5: Supervised Learning - Regression</h5>
    </div>
    <div class="accordion-content" id="accordion-5">
        <ul>
            <li>Introduction to supervised learning</li>
            <li>Linear regression and multiple regression</li>
            <li>Model evaluation and interpretation</li>
            <li>Feature selection and regularisation techniques</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(6)">
        <h5>6: Supervised Learning - Classification</h5>
    </div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(9)">
        <h5>9: Introduction to Deep Learning</h5>
    </div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(10)">
        <h5>10: Data Visualization and Communication</h5>
    </div>
    <div class="accordion-content" id="accordion-10">
        <ul>
            <li>Principles of effective data visualisation</li>
            <li>Data visualisation libraries (Matplotlib, Seaborn)</li>
            <li>Creating interactive visualisations (Plotly, Tableau)</li>
            <li>Communicating data insights effectively</li>
        </ul>
    </div>
</div>
