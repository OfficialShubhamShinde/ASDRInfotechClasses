...
<head>
    <meta charset="utf-8">
    <title>Frontend Development - ASDR Infotech</title>
...
<body>
                                    ...
                                    <div class="dropdown-submenu dropright">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="javafullstack">Full Stack Java
                                                Development</a>
                                            <a class="dropdown-item active" href="frontend">Frontend Development</a>
    ...
    <div class="container-fluid page-header" style="margin-bottom: 10px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">FRONT-END DEVELOPMENT</h3>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 0rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
            ...
            <h1 class="course-title" style="color: #FF6600;">Front-End Development</h1>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>Front-End Development course provides a comprehensive introduction to the field of front-end web
                        development. You will learn essential front-end technologies such as HTML, CSS, and JavaScript,
                        along with frameworks like React or Angular. Through hands-on projects and practical exercises,
                        students will gain the skills necessary to create interactive and visually appealing user
                ...
                <div class="col-lg-3">
                    <center>
                        <img src="img/html.jpg" alt="" style="width: 150px;">
                    </center>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>
                        <li>MSc(CS), BSc(CS), MCA, BCA, BE in Computer Science, IT, or related fields
                        </li>
                ...
                <div class="col-lg-3">
                    <center>
                        <img src="img/css.jpg" alt="" style="width: 150px;">
                    </center>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>
                        <li>Gain proficiency in HTML, CSS, and JavaScript.</li>

                        <li>Course completion certificate</li>

                        <li>Internship Certificate</li>

                        <li>Gain hands-on experience through real-world front-end development projects.</li>

                        <li>Develop skills in debugging and troubleshooting front-end code.</li>
                ...
                <div class="col-lg-3">
                    <center>
                        <img src="img/js.jpg" alt="" style="width: 150px;">
                    </center>
                </div>
            </div>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 1rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
                    ...
                    <div class="accordion">
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(1)">
                                <h5>1: Introduction to Front-End Development</h5>
                            </div>
                            <div class="accordion-content" id="accordion-1">
                                <ul>
                                    <li>Overview of front-end development and its role in web development</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(2)">
                                <h5>2: HTML Fundamentals</h5>
                            </div>
                            <div class="accordion-content" id="accordion-2">
                                <ul>
                                    <li>Structure and syntax of HTML</li>
                                    <li>Working with text, headings, paragraphs, and lists</li>
                                    <li>Adding links, images, and multimedia</li>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content" id="accordion-3">
                                <ul>
                                    ...
                                    <li>Styling text, colors, backgrounds, and borders</li>
                                    <li>Layout techniques: positioning, floats, and flexbox</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(5)">
                                <h5>5: CSS Preprocessors and Build Tools</h5>
                            </div>
                            <div class="accordion-content" id="accordion-5">
                                <ul>
                                    <li>Introduction to CSS preprocessors (e.g., Sass)</li>
                                    <li>Variables, mixins, and nesting in Sass</li>
                                    <li>Compiling Sass into CSS</li>
                                    <li>Introduction to build tools (e.g., npm, Gulp)</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(6)">
                                <h5>6: JavaScript Basics</h5>
                            </div>
                            <div class="accordion-content" id="accordion-6">
                                <ul>
                                    <li>Introduction to JavaScript and its role in front-end development</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(7)">
                                <h5>7: DOM Manipulation and Events</h5>
                            </div>
                            <div class="accordion-content" id="accordion-7">
                                <ul>
                                    ...
                                    <li>Handling events and event listeners</li>
                                    <li>Dynamic content updates with JavaScript</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(8)">
                                <h5>8: Modern JavaScript Development</h5>
                            </div>
                            <div class="accordion-content" id="accordion-8">
                                <ul>
                                    <li>Introduction to ES6+ features (arrow functions, destructuring, modules)</li>
                                    <li>Working with JavaScript frameworks (e.g., React, Vue.js)</li>
                                    <li>Introduction to package managers (e.g., npm) and bundlers (e.g., webpack)</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(9)">
                                <h5>9: Front-End Frameworks and Libraries</h5>
                            </div>
                            <div class="accordion-content" id="accordion-9">
                                <ul>
                                    <li>Introduction to front-end frameworks (e.g., Bootstrap, Foundation)</li>
                                    <li>Using pre-built components and grid systems</li>
                                    <li>Customizing and extending front-end frameworks</li>
                                    <li>CSS frameworks and utility libraries (e.g., Tailwind CSS)</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(10)">
                                <h5>10: Web Accessibility and Performance Optimization</h5>
                            </div>
                            <div class="accordion-content" id="accordion-10">
                                <ul>
                                    <li>Introduction to web accessibility and inclusive design</li>
                                    <li>Applying accessibility best practices in front-end development</li>
                                    <li>Performance optimization techniques (e.g., asset optimization, caching)</li>
                                    <li>Testing and debugging front-end code</li>
                                </ul>
                            </div>
                        </div>
            ...
            <p style="font-size: 10px; margin-top: 1rem;">Note: This syllabus provides a comprehensive outline for our
                Front End Development Course. The course content can be further customised to address specific design needs,
                industry standards, and advanced UI concepts as required by the students and the course objectives.
            </p>
        </div>
    </div>
    </div>
