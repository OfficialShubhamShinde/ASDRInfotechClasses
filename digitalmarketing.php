...
<head>
    <meta charset="utf-8">
    <title>Digital Marketing - ASDR Infotech</title>
...
<body>
                        ...
                        <div class="navbar-nav py-0">
                            ...
                            if ($user_type !== 'student' && $user_type !== 'teacher') {
                                ...
                                <div class="dropdown-menu" aria-labelledby="coursesDropdown">
                                    ...
                                    <!-- Marketing Courses -->
                                    <div class="dropdown-submenu dropright">
                                        <a class="dropdown-item dropdown-toggle active" href="#" id="marketingDropdown"
                                            data-toggle="dropdown">Marketing Courses</a>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item active" href="digitalmarketing">Digital Marketing</a>
    ...
    <div class="container-fluid page-header" style="margin-bottom: 10px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">Digital Marketing</h3>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 0rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
            ...
            <h1 class="course-title" style="color: #FF6600;">Digital Marketing</h1>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>This course introduces the fundamental concepts and techniques in digital marketing. Students
                        will learn the key principles and strategies for effective online marketing campaigns. The
                        course aims to develop students' skills in leveraging digital platforms to reach target
                        audiences, drive traffic, and achieve marketing objectives.
                    </ul>
                    </p>
                ...
                <div class="col-lg-3">
                    <center>
                        <img src="img/dm1.jpg" alt="" style="width: 200px;">
                    </center>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>Open to individuals with a basic understanding of marketing principles and an interest in
                        leveraging digital platforms for business growth. It is suitable for marketing professionals,
                        entrepreneurs, students, and anyone seeking to expand their knowledge of digital marketing
                        strategies</ul>
                    </p>
                </div>
                <!-- <div class="col-lg-3">
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>
                        <li>Understand the fundamental concepts and strategies</li>

                        <li>Course completion certificate</li>

                        <li>Internship Certificate</li>

                        <li>Gain insights into data analytics and measuring marketing performance.</li>

                        <li>Understand social media marketing strategies and utilise platforms effectively. </li>
                ...
                <div class="col-lg-3">
                    <center>
                        <img src="img/dm3.jpg" alt="" style="width: 200px;">
                    </center>
                </div>
            </div>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 1rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
                    ...
                    <div class="accordion">
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content" id="accordion-1">
                                <ul>
                                    ...
                                    <li>Key roles and responsibilities in digital marketing</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(2)">
                                <h5>2: Building an Online Presence</h5>
                            </div>
                            <div class="accordion-content" id="accordion-2">
                                <ul>
                                    <li>Understanding websites and domain names</li>
                                    <li>Website hosting and platforms</li>
                                    <li>User experience (UX) and website design principles</li>
                                </ul>
                            </div>
                        </div>
                        <div class="accordion-item">
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(4)">
                                <h5>4: Pay-Per-Click (PPC) Advertising</h5>
                            </div>
                            <div class="accordion-content" id="accordion-4">
                                <ul>
                                    <li>Introduction to PPC advertising</li>
                                    <li>Google Ads and Bing Ads platforms</li>
                                    <li>Creating and optimizing PPC campaigns</li>
                                    <li>Keyword bidding strategies and ad targeting</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(5)">
                                <h5>5: Social Media Marketing</h5>
                            </div>
                            <div class="accordion-content" id="accordion-5">
                                <ul>
                                    <li>Overview of social media platforms (Facebook, Instagram, Twitter, LinkedIn)</li>
                                    <li>Creating and optimizing social media profiles</li>
                                    <li>Content creation and posting strategies</li>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content" id="accordion-6">
                                <ul>
                                    ...
                                    <li>Email marketing tools and analytics</li>
                                </ul>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(7)">
                                <h5>7: Content Marketing</h5>
                            </div>
                            <div class="accordion-content" id="accordion-7">
                                <ul>
                                    <li>Understanding content marketing principles</li>
                                    <li>Developing a content marketing strategy</li>
                                    <li>Creating and promoting engaging content</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(8)">
                                <h5>8: Mobile Marketing</h5>
                            </div>
                            <div class="accordion-content" id="accordion-8">
                                <ul>
                                    <li>Mobile marketing trends and opportunities</li>
                                    <li>Creating mobile-optimized websites and apps</li>
                                    <li>Mobile advertising strategies</li>
                                    <li>Location-based marketing and proximity marketing</li>
                                </ul>
                            </div>
                        </div>
                        <!-- Sections 9 and 10 will follow the same format -->
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(9)">
                                <h5>9: Influencer Marketing and Affiliate Marketing</h5>
                            </div>
                            <div class="accordion-content" id="accordion-9">
                                <ul>
                                    <li>Introduction to influencer marketing</li>
                                    <li>Identifying and partnering with influencers</li>
                                    <li>Overview of affiliate marketing</li>
                                    <li>Setting up and managing affiliate programs</li>
                                </ul>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(10)">
                                <h5>10: Analytics and Performance Tracking</h5>
                            </div>
                            <div class="accordion-content" id="accordion-10">
                                <ul>
                                    ...
                                    <li>Tracking and measuring campaign performance</li>
            ...
            <p style="font-size: 10px; margin-top: 1rem;">Note: This syllabus provides a general outline for a Digital
                Marketing course. The instructor can further customise it based on the students' needs and the course
                objectives. Additional topics like social media listening and monitoring, online reputation management,
                marketing automation, or advanced digital advertising strategies can be included if desired.</p>
        </div>
    </div>
    </div>
