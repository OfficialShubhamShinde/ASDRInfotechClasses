...
<body>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" action="signup">
                                    ...
                                    <center>
                                        <button type="submit" name="register" class="btn btn-primary">Create
                                            Account</button>
                                    </center>
                                </form>
                            </div>
        ...
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                ...
                <div class="d-inline-flex text-white">
                    ...
                    <p class="m-0 text-uppercase">Enroll Course</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="latest-news-area" id="latest">
        <center>
            <a href="courseEnrollHistory.php" class="btn btn-primary mb-5">Enroll History</a>
        </center>
        <div class="container">

            <div class="row"> <!-- Add a row container -->
                <?php
                $sql = "select * from payment_status where student_id = $user_id";
                ...
                while ($row = mysqli_fetch_assoc($query)) {
                    ...
                    $selectCourseDetails = "select * from courses where course_id = $courId";
                    $querySelectCourseDetails = mysqli_query($conn, $selectCourseDetails);
                    $rowQuerySelectCourseDetails = mysqli_fetch_assoc($querySelectCourseDetails);

                    $fetchedCname = $rowQuerySelectCourseDetails['course_name'];

                    echo '
                        <div class="col-md-4 col-sm-6 col-xs-12 content-border" style="margin-bottom: 10px;">
                            <div class="latest-news-wrap">
                                <div class="card">
                                    <img src="teacher/' . $rowQuerySelectCourseDetails['course_img'] . '" class="card-img-top" width="400" height="250" alt="Language Image">
                                    <div class="card-body">
                                        <h5 class="card-title">' . $fetchedCname . '</h5>
                                        <div class="button-group">
                                            <a href="enrollToViewSyllabus?courseId='.$courId.'" class="btn btn-primary mt-3">View Syllabus</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 content-border" style="margin-bottom: 10px;">
          <div class="latest-news-wrap">
            <div class="card">
              <img src="' . $langimg . '" class="card-img-top" alt="Language Image">
              <div class="card-body">
                <h5 class="card-title">' . $langname . '</h5>
                <p class="card-text">' . $landesc . '</p>
                <a href="programming/java/java_programming.php?course_name=' . $langname . '" class="btn btn-primary">Start Reading...</a>
              </div>
            </div>
          </div>
        </div>';
