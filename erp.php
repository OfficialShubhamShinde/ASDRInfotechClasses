...
<body>
    ...
    <div class="container-fluid">
        <div class="row border-top px-xl-5"
            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <a href="index.php"><img src="img/ASDR LOGO.png" style="width: 166px; padding: 3px;"></a>
            </div>
            <div class="col-lg-9">
                            ...
                            if ($user_type !== 'student' && $user_type !== 'teacher') {
                                ...
                                <div class="dropdown-menu" aria-labelledby="coursesDropdown">
                                    ...
                                    <div class="dropdown-submenu dropright">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item active" href="erp">ERP Foundation</a>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 0rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
            ...
            <h1 class="course-title" style="color: #FF6600;">ERP Training</h1>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>The Enterprise Resource Planning (ERP) Fundamentals course is designed to provide participants
                        with a comprehensive understanding of ERP systems and their significance in modern business
                        operations. The course will delve into the core concepts, implementation processes, and benefits
                        of ERP systems, enabling participants to effectively manage business processes, streamline
                ...
                <div class="col-lg-3">
                    <center>
                        <img src="img/erp1.jpg" alt="" style="width: 200px;">
                    </center>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>Open to individuals with a basic computer literacy, proficiency in the course language, access
                        to a computer with internet, and a keen interest in understanding ERP systems and their impact
                        on business processes. Work experience in related fields is preferred but not mandatory.</ul>
                    </p>
                </div>
                <!-- <div class="col-lg-3">
            <center>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>
                        <li>Gain a solid foundation in ERP concepts and terminologies.</li>

                        <li>Course completion certificate</li>

                        <li>Internship Certificate</li>

                        <li>Enhance problem-solving abilities by applying ERP principles to real-world business
                            scenarios.</li>

                        <li>Understand the end-to-end lifecycle of ERP implementation.</li>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 1rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
                    ...
                    <div class="accordion">
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(1)">
                                <h5>1: Introduction to ERP</h5>
                            </div>
                            <div class="accordion-content" id="accordion-1">
                                <ul>
                                    <li>Definition, evolution, and benefits of ERP</li>
                                    <li>Overview of ERP modules (finance, HR, supply chain, etc.)</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(2)">
                                <h5>2: ERP Selection and Implementation</h5>
                            </div>
                            <div class="accordion-content" id="accordion-2">
                                <ul>
                                    <li>Needs assessment and defining requirements</li>
                                    <li>Vendor evaluation and selection process</li>
                                    <li>Project management for successful implementation</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(4)">
                                <h5>4: Data Migration and Integration</h5>
                            </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(5)">
                                <h5>5: Business Process Reengineering</h5>
                            </div>
                            <div class="accordion-content" id="accordion-5">
                                <ul>
                                    <li>Analyzing and optimizing existing processes</li>
                                    <li>Aligning processes with ERP best practices</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(6)">
                                <h5>6: Change Management and Training</h5>
                            </div>
                            <div class="accordion-content" id="accordion-6">
                                <ul>
                                    <li>Handling resistance to change</li>
                                    <li>Training employees for ERP adoption</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(8)">
                                <h5>8: Case Studies and Practical Applications</h5>
                            </div>
                            <div class="accordion-content" id="accordion-8">
                                <ul>
                                    <li>Real-world examples of successful ERP implementation</li>
                                    <li>Hands-on exercises using ERP software (simulation)</li>
                                </ul>
                            </div>
                        </div>
            ...
            <p style="font-size: 10px; margin-top: 1rem;"> The course content and schedule are subject to change based
                on the instructor's discretion and any emerging trends in the ERP field.
            </p>
        </div>
    </div>
    </div>
