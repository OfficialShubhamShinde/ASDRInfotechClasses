...
<head>
    <meta charset="utf-8">
    <title>Terms and Conditions | ASDR Infotech</title>
...
<div class="container container-fluid py-5">
    ...
    <ul>
        <p>By using the website <a href="https://asdrinfotech.in/">https://asdrinfotech.in/</a> and services provided by ASDR Infotech, you agree to comply with and be bound by these Terms and Conditions. If you do not agree with these terms, please do not use our website or services.</p>
    </ul>
    </section>
    <section>
        <h3>2. Use of the Website</h3>
        <ul>
        <p>2.1. You must be at least 18 years of age or have the necessary legal capacity to enter into these Terms and Conditions.</p>
        <p>2.2. You agree to use the website and services only for lawful purposes and in accordance with applicable laws and regulations.</p>
        <p>2.3. We reserve the right to modify or discontinue any aspect of the website or services at any time without notice.</p>
    </ul>
    </section>
    <section>
        <h3>3. Intellectual Property</h3>
         <ul>
        <p>3.1. All content on this website, including text, graphics, logos, images, and software, is the property of ASDR Infotech and is protected by copyright and other intellectual property laws.</p>
        <p>3.2. You may not use, reproduce, distribute, or modify any content from this website without prior written consent from ASDR Infotech.</p>
    </ul>
    </section>
    <section>
        <h3>4. Privacy Policy</h3>
        <ul>
        <p>Your use of this website and services is also governed by our Privacy Policy. By using our website and services, you consent to the collection, use, and disclosure of your information as described in our Privacy Policy.</p>
    </ul>
    </section>
    <section>
        <h3>5. Disclaimers</h3>
     <ul>
        <p>5.1. ASDR Infotech makes no warranties or representations about the accuracy or completeness of the content on this website or the suitability of our services for any particular purpose.</p>
        <p>5.2. We are not responsible for any errors, omissions, or inaccuracies in the content or services provided on this website.</p>
    </ul>
    </section>
    <section>
        <h3>6. Limitation of Liability</h3>
        <ul>
        <p>ASDR Infotech and its affiliates shall not be liable for any direct, indirect, incidental, special, or consequential damages arising from your use of this website or services, even if we have been advised of the possibility of such damages.</p></ul>
    </section>
    <section>
        <h3>7. Governing Law</h3>
        <ul>
        <p>These Terms and Conditions shall be governed by and construed in accordance with the laws of the state of Maharashtra, India. Any disputes arising from these terms shall be subject to the exclusive jurisdiction of the courts in Maharashtra.</p></ul>
    </section>
    <section>
        <h3>8. Changes to Terms and Conditions</h3>
        <ul>
        <p>ASDR Infotech reserves the right to modify these Terms and Conditions at any time. Any changes will be posted on this page, and it is your responsibility to review them periodically.</p></ul>
    </section>
    <section>
        ...
        <p>Address: Unit#201, Achal Leela Darshan, Baner Road, Baner, Pune-45</p></ul>
    </section>
