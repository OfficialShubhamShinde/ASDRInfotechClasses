...
<head>
    ...
    <style>
        table {
            ...
            width: 80%;
            margin: 20px auto;
            /* Add the following to add margins from the left and right sides */
            margin-left: 10%;
            margin-right: 10%;
            margin-bottom: 5%;
        }
    ...
    <div class="container-fluid page-header" style="margin-bottom: 90px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">Add Courses</h3>
...
<table>
    ...
    <?php
    // Loop through course data and display in table rows
    if (mysqli_num_rows($result) > 0) {
        $srno = 0;
        while ($row = mysqli_fetch_assoc($result)) {
            $startTime = $row["starttime"];
            $formattedStartTime = date_format(date_create($startTime), 'h:i A');

            $endTime = $row["endtime"];
            $formattedEndTime = date_format(date_create($endTime), 'h:i A');
            ...
            echo "<td>";
            echo "<a href='#' class='status' data-course-id='" . $row["course_id"] . "' data-status='" . $row["status"] . "'>" . $row["status"] . "</a>";
            echo "</td>";
            echo "<td><a href='editoverview.php?id=" . $row["course_id"] . "'>Edit</a></td>";
            echo "</tr>";
            $srno++;
        }
