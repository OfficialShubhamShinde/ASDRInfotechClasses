...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST["est"])) {
        ...
        $up = "UPDATE events SET etitle = '$etitle',edate = '$edate',eday = '$eday',emode = '$emode',estarttime = '$est',eendtime = '$et',elink = '$elink',edescription = '$edescription' WHERE event_id = $event_id";
    ...
    } elseif (isset($_POST["myEet"])) {
        $sq2 = "select * from events where event_id = '$event_id'";
        $q1 = mysqli_query($conn, $sq2);
        ...
        $ud2 = "UPDATE events SET etitle = '$etitle',edate = '$edate',eday = '$eday',emode = '$emode',estarttime = '$st',eendtime = '$eet',elink = '$elink',edescription = '$edescription' WHERE event_id = $event_id";
        $rs2 = mysqli_query($conn, $ud2);
        if ($rs2) {
            echo '
            <script>
                alert("Event Edited Successfully");
    ...
    } elseif(isset($_POST["est"]) && (isset($_POST["myEet"]))){
        $etitle = $_POST['etitle'];
        $edate = $_POST['edate'];
        $eday = $_POST['eday'];
        $emode = $_POST['emode'];
        ...
        $ud2 = "UPDATE events SET etitle = '$etitle',edate = '$edate',eday = '$eday',emode = '$emode',estarttime = '$est',eendtime = '$eet',elink = '$elink',edescription = '$edescription' WHERE event_id = $event_id";
        $rs2 = mysqli_query($conn, $ud2);
        if ($rs2) {
            echo '
            <script>
        ...
        $updateData = "UPDATE events SET etitle = '$etitle',edate = '$edate',eday = '$eday',emode = '$emode',elink = '$elink',edescription = '$edescription' WHERE event_id = $event_id";
...
<head>
    <meta charset="utf-8">
    <title>Event | ASDR Infotech</title>
...
<body>
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">Edit Event</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="index.html">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Edit Event</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5 mb-5 border rounded">
        <?php
        $selectEventDetails = "select * from events where event_id = '$event_id'";
        ...
        <form action="" method="post">
            <label for="exampleFormControlTextarea1" class="form-label">Event
                Title</label>
            <div class="mb-3">
                <input type="text" class="form-control" value="<?php echo $etitle ?>" id="name" name="etitle"
            ...
            <label for="exampleFormControlTextarea1" class="form-label">Event
                Date</label>
            <div class="mb-3">
                <input type="date" class="form-control" value="<?php echo $edate ?>" id="edate" name="edate">
            </div>

            <label for="exampleFormControlTextarea1" class="form-label">Event
                Day</label>
            <div class="mb-3">
                <select class="form-select" name="eday" value="" aria-label="Default select example"
            ...
            <label for="exampleFormControlTextarea1" class="form-label">Event
                Mode</label>
            <div class="mb-3">
                <select class="form-select" value="" name="emode" aria-label="Default select example"
                    style="width: 742px; padding: 7px; border-color: rgb(220,224,228);">
                    <option selected>
                        <?php echo $emode ?>
                    </option>
            ...
            <label for="exampleFormControlTextarea1" class="form-label">Event Start
                Time</label>
            <div class="mb-3">
                <input type="time" class="form-control" id="exampleInputEmail1" name="est" aria-describedby="emailHelp">
            ...
            <label for="exampleFormControlTextarea1" class="form-label">Event End
                Time</label>
            <div class="mb-3">
                <input type="time" class="form-control" id="exampleInputEmail11" name="myEet"
            ...
            <label for="exampleFormControlTextarea1" class="form-label">Event
                Link</label>
            <div class="mb-3">
                <input type="text" class="form-control" value="<?php echo $elink ?>" id="elink" required name="elink">
            </div>
            ...
            <div class="form-floating mb-3 mt-2">
                <textarea class="form-control" placeholder="" name="edescription" id="detail"
                    style="height: 100px"><?php echo $edescription ?></textarea>
            </div>

            <center><button type="submit" class="btn btn-primary btn-lg px-4 me-md-2 mb-3">Update Event</button>
            </center>
        </form>
    </div>
