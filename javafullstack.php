...
<head>
    <meta charset="utf-8">
    <title>Java Full Stack - ASDR Infotech</title>
...
<body>
                                ...
                                <div class="dropdown-menu" aria-labelledby="coursesDropdown">
                                    ...
                                    <div class="dropdown-submenu dropright">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="webfullstack">Full Stack Web
                                                Development</a>
                                            <a class="dropdown-item active" href="javafullstack">Full Stack Java
                                                Development</a>
                                            <a class="dropdown-item" href="frontend">Frontend Development</a>
                                            <a class="dropdown-item" href="java">Java</a>
                                            <a class="dropdown-item" href="python">Python</a>
    ...
    <div class="container-fluid page-header" style="margin-bottom: 10px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">Java Full Stack Development</h3>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 0rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
            ...
            <h1 class="course-title" style="color: #FF6600;">Java Full Stack Development</h1>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>Java Full Stack Development course introduces the fundamentals of Java programming, equipping
                        students with the necessary skills to become proficient in the language. Throughout the course,
                        participants will gain a solid understanding of Java syntax, object-oriented concepts, and key
                        programming techniques. The primary objective is to enhance students' problem-solving abilities
                        and lay a strong foundation for their further studies in software development using Java.</ul>
                    </p>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 1rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
                    ...
                    <div class="accordion">
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(2)">
                                <h5>2: Object-Oriented Programming (OOP) Fundamentals</h5>
                            </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(3)">
                                <h5>3: Java Language Basics</h5>
                            </div>
                            <div class="accordion-content" id="accordion-3">
                                <ul>
                                    <li>Variables and Data Types</li>
                                    <li>Arrays and Operators</li>
                                    <li>Control Flow Statements (if, else, switch, while, for)</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(4)">
                                <h5>4: Java Web Development Basics</h5>
                            </div>
                            <div class="accordion-content" id="accordion-4">
                                <ul>
                                    ...
                                    <li>Introduction to Front-end Frameworks (e.g., React, Angular)</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(5)">
                                <h5>5: Database and SQL Fundamentals</h5>
                            </div>
                            <div class="accordion-content" id="accordion-5">
                                <ul>
                                    <li>Introduction to Relational Databases</li>
                                    <li>MySQL or other Database Management Systems</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(6)">
                                <h5>6: Java Web Development - Servlets and JSP</h5>
                            </div>
                            <div class="accordion-content" id="accordion-6">
                                <ul>
                                    <li>Introduction to Servlets</li>
                                    <li>Servlet Lifecycle and Configuration</li>
                                    <li>JavaServer Pages (JSP) Basics</li>
                                    <li>JSP Scripting Elements and Directives</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(8)">
                                <h5>8: Full Stack Development - Backend:</h5>
                            </div>
                            <div class="accordion-content" id="accordion-8">
                                <ul>
                                    <li>Building RESTful APIs with Java and Spring Boot</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(9)">
                                <h5>9: Full Stack Development - Frontend:</h5>
                            </div>
                            <div class="accordion-content" id="accordion-9">
                                <ul>
                                    <li>Building Responsive User Interfaces with HTML, CSS, and JavaScript</li>
                                    <li>Frontend Framework Integration (React, Angular, or Vue.js)</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(11)">
                                <h5>11: Deployment and Hosting</h5>
                            </div>
                            <div class="accordion-content" id="accordion-11">
                                <ul>
                                    <li>Deploying Java Applications</li>
                                    <li>Application Hosting and Server Configurations</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(12)">
                                <h5>12: Version Control and Collaboration</h5>
                            </div>
                            <div class="accordion-content" id="accordion-12">
                                <ul>
                                    <li>Git Version Control Basics</li>
                                    <li>Collaborative Development with Git</li>
                                </ul>
                            </div>
                        </div>
            ...
            <p style="font-size: 10px; margin-top: 1rem;">Note: This syllabus provides a general outline for a Full
                Stack Java Development course. Additional topics and projects may be included based on the course's
                depth and requirements. Students will gain proficiency in Java, web development technologies (HTML, CSS,
                JS), MySQL, and popular frameworks to become competent Full Stack Java Developers.</p>
        </div>
    </div>
    </div>
