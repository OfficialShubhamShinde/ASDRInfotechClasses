...
<head>
    <meta charset="utf-8">
    <title>Java - ASDR Infotech</title>
...
<body>
                                ...
                                <div class="dropdown-menu" aria-labelledby="coursesDropdown">
                                    ...
                                    <div class="dropdown-submenu dropright">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item active" href="java">Java</a>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 0rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
            ...
            <h1 class="course-title" style="color: #FF6600;">Java</h1>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>Java course is designed to provide a comprehensive understanding of the Java programming
                        language. You will learn the core concepts of Java, including object-oriented programming, data
                        types, control structures, exception handling, and file handling. The course covers both theory
                        and practical implementation, enabling students to develop robust Java applications.
                    </ul>
                    </p>
                ...
                <div class="col-lg-3">
                    <center>
                        <img src="img/java.jpg" alt="" style="width: 200px;">
                    </center>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>
                        ...
                        <li>Gain hands-on experience through practical assignments.</li>

                        <li>Opportunity to work on a real-world Java project.</li>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 1rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
                    ...
                    <div class="accordion">
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content" id="accordion-1">
                                <ul>
                                    ...
                                    <li>Features of the Java Language</li>
                                    <li>Introduction to the Java Virtual Machine (JVM)</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(2)">
                                <h5>2: Java Program Development</h5>
                            </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content" id="accordion-3">
                                <ul>
                                    ...
                                    <li>Looping structures (while, do-while, for)</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(4)">
                                <h5>4: Object-Oriented Programming (OOP) Fundamentals</h5>
                            </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content" id="accordion-5">
                                <ul>
                                    ...
                                    <li>Arrays</li>
                                    <li>Operators (Assignment, Arithmetic, Unary, Equality, Relational, Conditional)
                                    </li>
                                    <li>Expressions, Statements, and Blocks</li>
                                    <li>Control Flow Statements (if-then, if-then-else, switch, while, do-while, for)
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(6)">
                                <h5>6: Classes and Objects</h5>
                            </div>
                            <div class="accordion-content" id="accordion-6">
                                <ul>
                                    <li>Declaring and Defining Classes</li>
                                    <li>Member Variables and Methods</li>
                                    <li>Passing Information to Methods or Constructors</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(7)">
                                <h5>7: Interface and Inheritance</h5>
                            </div>
                            <div class="accordion-content" id="accordion-7">
                                <ul>
                                    <li>Defining and Implementing Interfaces</li>
                                    <li>Using Interfaces as Types</li>
                                    <li>Overriding and Method Hiding</li>
                                    <li>Final Class and Methods</li>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content" id="accordion-9">
                                <ul>
                                    ...
                                    <li>Defining and Starting Threads</li>
                                    <li>Sleeping and Interrupting Threads</li>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content" id="accordion-10">
                                <ul>
                                    ...
                                    <li>ArrayList, LinkedList, ListIterator</li>
                                    <li>HashSet, LinkedHashSet, TreeSet</li>
                                    <li>Map, HashMap, TreeMap, Hashtable</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(11)">
                                <h5>11: Java Database Connectivity (JDBC)</h5>
                            </div>
                            <div class="accordion-content" id="accordion-11">
                                <ul>
                                    <li>JDBC Architecture</li>
                                    <li>Database Overview</li>
                                    <li>Basic JDBC Operations</li>
                                    <li>Processing SQL Statements</li>
                                    <li>Result Sets</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(12)">
                                <h5>12: JavaServer Pages (JSP)</h5>
                            </div>
                            <div class="accordion-content" id="accordion-12">
                                <ul>
                                    <li>JSP Basics</li>
                                    <li>Disadvantages of Servlets</li>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content" id="accordion-13">
                                <ul>
                                    <li>Introduction to Spring Framework Architecture</li>
                                    <li>IoC Containers</li>
                                    <li>Bean Definition and Scopes</li>
                                    <li>Bean Post Processors</li>
                                    <li>Dependency Injection and Auto-Wiring</li>
                                    <li>Integrating Spring Framework with Hibernate</li>
                                    <li>Transaction Management</li>
                                    <li>Design Patterns: DAO, DTO, MVC</li>
            ...
            <p style="font-size: 10px; margin-top: 1rem;">Note: This syllabus provides a comprehensive outline for our
                Java Course. The course content can be further customised to address specific development needs,
                industry standards, and advanced Java concepts as required by the students and the course objectives.
            </p>
        </div>
    </div>
    </div>
