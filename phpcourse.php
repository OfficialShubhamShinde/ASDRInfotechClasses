...
<body>
                                ...
                                <div class="dropdown-menu" aria-labelledby="coursesDropdown">
                                    ...
                                    <div class="dropdown-submenu dropright">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item active" href="phpcourse">PHP</a>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 0rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
            ...
            <h1 class="course-title" style="color: #FF6600;">PHP</h1>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>PHP (Hypertext Preprocessor) is a widely-used open-source scripting language that is particularly suited for web development and can be embedded into HTML. This course provides a comprehensive understanding of PHP, its applications, and its role in modern web development.
                    </ul>
                    </p>
                ...
                <div class="col-lg-3">
                    <center>
                        <img src="img/php.jpg" alt="" style="width: 200px;">
                    </center>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>
                        <li>Gain the skills needed to create dynamic web applications, websites, and web services using PHP.</li>
                        ...
                        <li>Opportunity to work on a real-world Python project.</li>
...
<div class="accordion-item">
    ...
    <div class="accordion-content" id="accordion-2">
        <ul>
            ...
            <li>Control structures (if, else, switch)</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(4)">
        <h5>4: Web Development with PHP</h5>
    </div>
    <div class="accordion-content" id="accordion-4">
        <ul>
            <li>Forms and user input handling</li>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(8)">
        <h5>8: PHP Frameworks (Optional)</h5>
    </div>
    <div class="accordion-content" id="accordion-8">
        <ul>
            <li>Introduction to popular PHP frameworks like Laravel or Symfony</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class= "accordion-header" onclick="toggleAccordion(9)">
        <h5>9: Project Development</h5>
    </div>
    <div class="accordion-content" id="accordion-9">
        <ul>
            <li>Building a complete web application using PHP</li>
            <li>Applying best practices in web development</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(10)">
        <h5>10: Deployment and Hosting</h5>
    </div>
    <div class="accordion-content" id="accordion-10">
        <ul>
            <li>Preparing your PHP application for deployment</li>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(11)">
        <h5>11: Advanced Topics (Optional)</h5>
    </div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(12)">
        <h5>12: Final Project</h5>
    </div>
    <div class="accordion-content" id="accordion-12">
        <ul>
            <li>Developing a capstone project to showcase your PHP skills</li>
        </ul>
    </div>
</div>
            ...
            <p style="font-size: 10px; margin-top: 1rem;">Note: This syllabus provides a comprehensive outline for our
                PHP Course. The course content can be further customised to address specific needs,
