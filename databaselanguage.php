...
<head>
    <meta charset="utf-8">
    <title>Database - ASDR Infotech</title>
...
<body>
                                ...
                                <div class="dropdown-menu " aria-labelledby="coursesDropdown">
                                    ...
                                    <div class="dropdown-submenu dropright">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item active" href="databaselanguage">Database</a>
                                        </div>
                                    </div>
    ...
    <div class="container-fluid page-header" style="margin-bottom: 10px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">Database</h3>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 0rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
            ...
            <h1 class="course-title" style="color: #FF6600;">Database</h1>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>Database course provides a comprehensive understanding of database management systems and their
                        role in modern applications. Participants will learn about relational databases, SQL (Structured
                        Query Language), data modeling, normalisation, indexing, and database administration. Through
                        hands-on exercises and real-world scenarios, students will gain the skills necessary to design,
                        implement, and manage databases effectively.
                    </ul>
                    </p>
                ...
                <div class="col-lg-3">
                    <center>
                        <img src="img/sql.jpg" alt="" style="width: 200px;">
                    </center>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>
                        Open to individuals with basic computer literacy and a keen interest in database management. No
                        prior knowledge of databases is required, making it suitable for beginners. The course is ideal
                        for students, aspiring database administrators, and professionals looking to enhance their
                        database skills.
                    </ul>
                    </p>
                </div>
                <!-- <div class="col-lg-3">
            <center>
            <img src="img/nosql.jpg" alt="" style="width: 200px; padding-bottom: 1.5rem;">
            </center>
        </div> -->
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>
                        <li>Gain proficiency in writing SQL queries for data retrieval, manipulation, and management.
                        </li>
                        ...
                        <li>Acquire knowledge of database indexing and optimization techniques</li>
                ...
                <!-- <div class="col-lg-3">
            <center>
            <img src="img/orm.jpg" alt="" style="width: 200px;">
            </center> -->
            </div>
        </div>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 1rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
                    ...
                    <div class="accordion">
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(1)">
                                <h5>1: Introduction to Databases</h5>
                            </div>
                            <div class="accordion-content" id="accordion-1">
                                <ul>
                                    <li>Overview of databases and their role in information management</li>
                                    <li>Types of databases (relational, object-oriented, NoSQL, etc.)</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(2)">
                                <h5>2: Relational Database Concepts</h5>
                            </div>
                            <div class="accordion-content" id="accordion-2">
                                <ul>
                                    <li>Relational database model and principles</li>
                                    <li>Entities, attributes, and relationships</li>
                                    <li>Database schemas and tables</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(3)">
                                <h5>3: Entity-Relationship (ER) Modeling</h5>
                            </div>
                            <div class="accordion-content" id="accordion-3">
                                <ul>
                                    <li>Introduction to ER modeling and diagrams</li>
                                    <li>Entity types, attributes, and relationships</li>
                                    <li>Cardinality and participation constraints</li>
                                </ul>
                            </div>
                        </div>

                        <!-- Continue adding the remaining sections following the same structure -->
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(4)">
                                <h5>4: Introduction to SQL</h5>
                            </div>
                            <div class="accordion-content" id="accordion-4">
                                <ul>
                                    <li>Structured Query Language (SQL) and its role in database management</li>
                                    <li>Basic SQL syntax and data manipulation commands (SELECT, INSERT, UPDATE, DELETE)
                                    </li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(6)">
                                <h5>6: Database Design and Normalization</h5>
                            </div>
                            <div class="accordion-content" id="accordion-6">
                                <ul>
                                    <li>Functional dependencies and normalization concepts</li>
                                    <li>Normal forms (1NF, 2NF, 3NF)</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(7)">
                                <h5>7: Database Administration</h5>
                            </div>
                            <div class="accordion-content" id="accordion-7">
                                <ul>
                                    <li>Introduction to database administration tasks and responsibilities</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(8)">
                                <h5>8: Database Connectivity and APIs</h5>
                            </div>
                            <div class="accordion-content" id="accordion-8">
                                <ul>
                                    <li>Connecting databases to applications</li>
                                    <li>Introduction to database APIs (e.g., JDBC, ODBC)</li>
                                    <li>Working with database drivers and connection strings</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(9)">
                                <h5>9: Introduction to NoSQL Databases</h5>
                            </div>
                            <div class="accordion-content" id="accordion-9">
                                <ul>
                                    <li>Overview of NoSQL databases and their characteristics</li>
                                    <li>Key-value stores, document databases, column-family databases, and graph
                                        databases</li>
                                    <li>Introduction to MongoDB and Cassandra</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(10)">
                                <h5>10: Database Trends and Emerging Technologies</h5>
                            </div>
                            <div class="accordion-content" id="accordion-10">
                                <ul>
                                    <li>Introduction to cloud databases and database-as-a-service (DBaaS)</li>
                                    <li>Big data and distributed databases</li>
                                    <li>Introduction to data warehousing and business intelligence</li>
                                </ul>
                            </div>
                        </div>
            ...
            <p style="font-size: 10px; margin-top: 1rem;">Note: This syllabus provides a general outline for a Database
                course. The instructor can further customize it based on the students' needs and the course objectives.
                Additional topics like advanced SQL, database design patterns, data modeling techniques, or specific
                database management systems (Oracle, SQL Server, etc.) can be included in more advanced courses.
            </p>
        </div>
    </div>
    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5" style="padding: 0rem !important;">
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    <h2 class="text-primary text-uppercase mb-3">SQL</h2>
                    <ul>Structured Query Language is a standard language for managing relational databases. It includes
                        data definition language (DDL) statements for creating and modifying database schemas, data
                        manipulation language (DML) statements for inserting, updating, and deleting data, and data
                        query language (DQL) statements for retrieving data. </ul>
                    <ul>
                        Examples of SQL-based databases include MySQL, PostgreSQL, Oracle, Microsoft SQL Server, and
                        SQLite.
                    </ul>
                </div>
                ...
                <!-- <div class="col-lg-3">
            <center>
            <img src="img/sql.jpg" alt="" style="width: 161px;">
            </center>
        </div> -->
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    <h2 class="text-primary text-uppercase mb-3">NoSQL</h2>
                    <ul>NoSQL Query Languages: NoSQL databases use different query languages specific to their database
                        systems. Some popular NoSQL databases and their associated query languages are:
                    </ul>
                    <ul>
                        MongoDB: MongoDB uses MongoDB Query Language (MQL), which provides flexible and dynamic querying
                        capabilities.</ul>
                    <ul> Cassandra: Cassandra Query Language (CQL) is used for interacting with the Cassandra database.
                    </ul>
                    <ul> CouchDB: CouchDB uses MapReduce queries and the Mango Query Language.
                    </ul>
                </div>

                <div class="col-lg-3">
                    <center>
                        <img src="img/nosql.jpg" alt="" style="width: 161px;">
                    </center>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    <h2 class="text-primary text-uppercase mb-3">ORM</h2>
                    <ul>Object-Relational Mapping (ORM) Query frameworks provide query languages that allow developers
                        to interact with databases using object-oriented paradigms. </ul>
                    <ul>Examples include:<br>

                        Hibernate Query Language (HQL):</ul>
                    <ul>Used with Hibernate ORM for Java applications.<br>
                        Entity Framework: Used with .NET applications.<br>
                        Django ORM: Used with Python applications.</ul>
                </div>

                <div class="col-lg-3">
                    <center>
                        <img src="img/orm.jpg" alt="" style="width: 161px;">
                    </center>
                </div>
            </div>
