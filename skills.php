...
<head>
    <meta charset="utf-8">
    <title>Softskills - ASDR Infotech</title>
...
<body>
                            ...
                            if ($user_type !== 'student' && $user_type !== 'teacher') {
                                ...
                                <div class="dropdown-menu" aria-labelledby="coursesDropdown">
                                    ...
                                    <div class="dropdown-submenu dropright">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item active" href="skills">Softskills</a>
                                        </div>
                                    </div>
    ...
    <div class="container-fluid page-header" style="margin-bottom: 10px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">Employability Softskills</h3>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 0rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
            ...
            <h1 class="course-title" style="color: #FF6600;">Employability Softskills</h1>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>You have finished graduation, are equipped with all the technical skills needed, and applied for
                        the job. After waiting for a long still not able to land any opportunity, wondering what else we
                        need.

                        These are Employability Softskills. These are the skills the Employer expects candidates will
                        have. If you are looking for a new job or working professional and want to grow in an
                        organization, you need to upskill with the training from an expert. Join our soft skills
                        training programs tailored according to candidates' profiles.
                    </ul>
    ...
    <div class="container-fluid py-5" style="padding-top: 1rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    <h5 class="text-primary text-uppercase mb-3">Resume Writing and Cover Letter</h5>
                    <p>This short course will teach you how to write a great resume that will stand out from the other
                        candidates. A cover letter helps employers see what you have to offer at a glance and take your
                        application at the top. You will learn tools and techniques to write a winning resume and cover
                        letter.
                    </p>
                </div>
                ...
                <div class="col-lg-3">
                    <center>
                        <img src="img/skill1.jpg" alt="" style="width: 161px;">
                    </center>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    <h5 class="text-primary text-uppercase mb-3">Interview Techniques</h5>
                    <p>If you are looking for a new job or promotion this program will help you to prepare for your next
                        Interview. You will learn various techniques such as how to perform before and during the
                        interview, and answer tough questions, giving your best chance for success.
                    </p>
                </div>

                <div class="col-lg-3">
                    <center>
                        <img src="img/skill2.jpg" alt="" style="width: 161px;">
                    </center>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    <h5 class="text-primary text-uppercase mb-3">Soft Skills</h5>
                    <p>Softskills are the interpersonal skills that are crucial for your career. Soft skills include
                        problem-solving, communication, team building, and the list goes on. With soft skills, you will
                        excel as a leader. This program will train you with these skills with practice assignments.
                    </p>
                </div>

                <div class="col-lg-3">
                    <center>
                        <img src="img/skill3.jpg" alt="" style="width: 161px;">
                    </center>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    <h5 class="text-primary text-uppercase mb-3">Job Readiness Program</h5>
                    <p>This is our most popular program. It combines all the techniques and skills such as Resume
                        writing, Interview skills, and soft skills. Industry experts will cover the topics while sharing
                        their experiences.
                    </p>
                </div>
                ...
                <div class="col-lg-3">
                    <center>
                        <img src="img/skill4.jpg" alt="" style="width: 161px;">
                    </center>
                </div>
            </div>

            <button class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2" onclick="goBack()">Back</button>
            <a href="course" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Courses</a>
