...
<head>
    <meta charset="utf-8">
    <title>Python - ASDR Infotech</title>
...
<body>
                                ...
                                <div class="dropdown-menu" aria-labelledby="coursesDropdown">
                                    ...
                                    <div class="dropdown-submenu dropright">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item active" href="python">Python</a>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 0rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
            ...
            <h1 class="course-title" style="color: #FF6600;">Python</h1>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>Python course offers a comprehensive introduction to the Python programming language. You will
                        learn the fundamentals of Python, including variables, data types, control flow, functions, and
                        modules. Through hands-on exercises and projects, students will gain practical experience in
                ...
                <div class="col-lg-3">
                    <center>
                        <img src="img/python.jpg" alt="" style="width: 200px;">
                    </center>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-9">
                    ...
                    <ul>
                        <li>Develop a solid understanding of Python programming concepts.</li>
    ...
    <div class="container-fluid py-5" style="padding-bottom: 1rem !important;">
        <div class="container py-5" style="padding: 0rem !important;">
                    ...
                    <div class="accordion">
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(1)">
                                <h5>1: Introduction to Python</h5>
                            </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(2)">
                                <h5>2: Variables and Operators</h5>
                            </div>
                            <div class="accordion-content" id="accordion-2">
                                <ul>
                                    <li>Variables and data assignment</li>
                                    <li>Numeric and string operators</li>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content" id="accordion-3">
                                <ul>
                                    ...
                                    <li>Looping structures (while, for)</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(6)">
                                <h5>6: Dictionaries and Sets</h5>
                            </div>
                            <div class="accordion-content" id="accordion-6">
                                <ul>
                                    <li>Dictionary fundamentals</li>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(8)">
                                <h5>8: Object-Oriented Programming</h5>
                            </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" onclick="toggleAccordion(9)">
                                <h5>9: Modules and Packages</h5>
                            </div>
                            <div class="accordion-content" id="accordion-9">
                                <ul>
                                    <li>Creating and importing modules</li>
                                    <li>Using built-in and third-party modules</li>
                                    <li>Introduction to Python packages</li>
                                </ul>
                            </div>
                        </div>
            ...
            <p style="font-size: 10px; margin-top: 1rem;">Note: This syllabus provides a comprehensive outline for our
                Python Course. The course content can be further customised to address specific needs,
