...
<head>
    <meta charset="utf-8">
    <title>Software Testing - ASDR Infotech</title>
                        ...
                        <div class="navbar-nav py-0">
                            ...
                            <a href="contact" class="nav-item nav-link">Contact</a>
                                ...
                                <div class="dropdown-menu" aria-labelledby="coursesDropdown">
                                    ...
                                    <!-- Testing Courses -->
                                    <div class="dropdown-submenu dropright">
                                        <a class="dropdown-item dropdown-toggle active" href="#" id="testingDropdown"
                                            data-toggle="dropdown">Testing Courses</a>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item active" href="softwaretesting">Manual/Automation
                                                Testing</a>
    ...
    <div class="container-fluid page-header" style="margin-bottom: 10px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">Software Testing</h3>
...
<div class="container-fluid py-5" style="padding-bottom: 0rem !important;">
 ...
 <h1 class="course-title" style="color: #FF6600;">Software Testing</h1>
...
<ul>
<li>Learn test planning and test design strategies for effective test coverage.</li>

<li>Course completion certificate</li>

<li>Internship Certificate</li>

<li>Gain hands-on experience with popular testing tools and frameworks.</li>
...
<!-- <button class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2" onclick="goBack()">Back</button> -->
        ...
        <div class="col-lg-3">
            <center>
            <img src="img/automation.jpg" alt="" style="width: 200px;">
            </center>
        </div>
        </div>
...
<!-- <div class="container"> -->
    ...
    <div class="accordion-content" id="accordion-1">
        <ul>
            <li>Overview of software testing and its role in development</li>
            <li>Software testers' significance in the software development life cycle (SDLC)</li>
            <li>Exploration of software testing types: functional, non-functional, manual, automated</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(2)">
        <h5>2: Software Testing Fundamentals</h5>
    </div>
    <div class="accordion-content" id="accordion-2">
        <ul>
            <li>Understanding test requirements and effective planning</li>
            <li>Utilizing test design techniques: black-box, white-box, boundary value, equivalence partitioning</li>
            <li>Creation of comprehensive test cases and scenarios</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(3)">
        <h5>3: Manual Testing</h5>
    </div>
    <div class="accordion-content" id="accordion-3">
        <ul>
            <li>Embracing manual testing principles and best practices</li>
            <li>Precise test execution and comprehensive defect reporting</li>
            <li>Exploratory and ad-hoc testing strategies</li>
            <li>Regression and smoke testing implementation</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(4)">
        <h5>4: Test Automation Basics</h5>
    </div>
    <div class="accordion-content" id="accordion-4">
        <ul>
            <li>Introduction to test automation and its benefits</li>
            <li>Selecting appropriate test cases for automation</li>
            <li>Introduction to popular automation testing tools (e.g., Selenium, JUnit, TestNG)</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(5)">
        <h5>5: Test Automation Frameworks</h5>
    </div>
    <div class="accordion-content" id="accordion-5">
        <ul>
            <li>Data-driven testing and keyword-driven testing</li>
            <li>Creating and maintaining test automation scripts</li>
            <li>Best practices for writing maintainable and scalable test scripts</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(6)">
        <h5>6: Continuous Integration and Continuous Testing</h5>
    </div>
    <div class="accordion-content" id="accordion-6">
        <ul>
            <li>Integrating testing into the CI/CD pipeline</li>
            <li>Automating test execution in the CI environment</li>
            <li>Implementing continuous testing to ensure faster feedback loops</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    ...
    <div class="accordion-content" id="accordion-7">
        <ul>
            <li>Introduction to performance testing and its objectives</li>
            <li>Load testing, stress testing, and scalability testing</li>
            <li>Using tools like JMeter or Gatling for performance testing</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(8)">
        <h5>8: Security Testing</h5>
    </div>
    <div class="accordion-content" id="accordion-8">
        <ul>
            <li>Understanding security testing and its importance</li>
            <li>Identifying common security vulnerabilities (e.g., SQL injection, cross-site scripting)</li>
            <li>Conducting security testing using tools like OWASP ZAP or Burp Suite</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(9)">
        <h5>9: Mobile App Testing</h5>
    </div>
    <div class="accordion-content" id="accordion-9">
        <ul>
            <li>Challenges in mobile app testing</li>
            <li>Testing on different mobile platforms (Android, iOS)</li>
            <li>Emulators and real device testing</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(10)">
        <h5>10: Usability Testing</h5>
    </div>
    <div class="accordion-content" id="accordion-10">
        <ul>
            <li>Evaluating user-friendliness of applications</li>
            <li>Conducting usability tests and gathering user feedback</li>
            <li>Enhancing user experience through testing</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(11)">
        <h5>11: Defect Management and Reporting</h5>
    </div>
    <div class="accordion-content" id="accordion-11">
        <ul>
            <li>Managing the defect lifecycle with tools like Jira or Bugzilla</li>
            <li>Creating clear and concise defect reports</li>
            <li>Collaborating with developers for efficient defect resolution</li>
        </ul>
    </div>
</div>
...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(12)">
        <h5>12: Test Metrics and Reporting</h5>
    </div>
    <div class="accordion-content" id="accordion-12">
        <ul>
            <li>Measuring test progress and quality with relevant metrics</li>
            <li>Generating comprehensive test reports and informative dashboards</li>
            <li>Driving continuous improvement through thorough test data analysis</li>
        </ul>
    </div>
</div>
...
<p style="font-size: 10px; margin-top: 1rem;">Note: This syllabus provides a comprehensive outline for our Software Testing Course. The course content can be further customised to address specific testing needs, industry standards, and advanced testing concepts as required by the students and the course objectives.</p>
    </div>
    </div>
</div>
