...
?>
<?php 
$fetchSname = "select * from users where user_id = $user_id";
$queryFetchSname = mysqli_query($conn, $fetchSname);
$RowFetchSname = mysqli_fetch_assoc($queryFetchSname);
$SName = $RowFetchSname['name'];
?>
...
<head>
    <meta charset="utf-8">
    <title>Enroll History | ASDR Infotech</title>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0"
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav py-0">
                            ...
                            <a href="course" class="nav-item nav-link ">Enroll</a>
                            <a href="internship" class="nav-item nav-link ">Internship Program</a>
                            <a href="enroll" class="nav-item nav-link active">My Learnings</a>
    ...
    <div class="container-fluid page-header" style="margin-bottom: 0px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
                <h3 class="display-4 text-white text-uppercase">Enroll History</h3>
        ...
        <div class="container py-5">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $select = "select * from payment_status where student_id = $user_id";
                        $query = mysqli_query($conn, $select);

                        while ($row = mysqli_fetch_assoc($query)) {
                            $courseid = $row['course_id'];
                            $fetchCname = "select * from payment_status where student_id = $user_id AND course_id = $courseid";
                            $queryFetchCname = mysqli_query($conn, $fetchCname);
                            $rowQueryFetchCname = mysqli_fetch_assoc($queryFetchCname);
                            // $cname = $rowQueryFetchCname['course_name'];
                            // select course name
                            $selectCourname = "select * from courses where course_id = $courseid";
                            $queryefetchh = mysqli_query($conn, $selectCourname);
                            $fetcgSelectCourname = mysqli_fetch_assoc($queryefetchh);

                            $cname = $fetcgSelectCourname['course_name'];
                            $cAmount = $rowQueryFetchCname['amount_pay'];

                            $cdate = $row['payment_datetime'];
                            $formatedCDate = date_format(date_create($cdate), 'Y/m/d');

                            echo '
                            <tr>
                                <th scope="row">' . $formatedCDate . '</th>
                                <td>' . $cname . '</td>
                                <td>' . $cAmount . '</td>
                                <td>
                                    <a href="printReceipt.php?sname='.$SName.'&cname='.$cname.'&cid='.$courseid.'&sId='.$user_id.'">
                                        <center>
