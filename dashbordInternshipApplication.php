...
<body style="font-family: 'Poppins', sans-serif;">
    ...
    <div class="sidebarMenu">
        ...
        <div class="container">
            ...
            <center>
                <h2 class="text-primary text-uppercase mb-3" style="letter-spacing: 5px;">Application Details</h2>
            </center>
            <br>
            <?php 
             $sqlInternDetails = "select * from internship_program";
             $querySqlInternDetails = mysqli_query($conn, $sqlInternDetails); 

             if (mysqli_num_rows($querySqlInternDetails) > 0){
                ?>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr class="text-center">
                            ...
                            <th scope="col">Applied for Position</th>
                    ...
                    <tbody>
                        ...
                        while ($rowsqlInternDetails = mysqli_fetch_assoc($querySqlInternDetails)) {
                            $internid  = $rowsqlInternDetails['internid'];
                            $name  = $rowsqlInternDetails['name'];
                            $email  = $rowsqlInternDetails['email'];
                            $contactno  = $rowsqlInternDetails['contactno'];
                            $position  = $rowsqlInternDetails['position'];
                            $message  = $rowsqlInternDetails['message'];
                            $resume  = $rowsqlInternDetails['resume'];
                            $coverlatter  = $rowsqlInternDetails['coverlatter'];
                            ...
                            <td>
                                <center>
                                    <a href="viewInternResume?applicantid='.$internid.'">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                            style="color:#FF6600" class="bi bi-eye-fill" viewBox="0 0 16 16">
                            ...
                            <td>
                                <center>
                                    <a href="viewInternCoverlatter?applicantid='.$internid.'">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                            style="color:#FF6600" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                            <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z" />
                                            <path
